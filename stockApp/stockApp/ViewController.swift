...
//  stockApp
//
//  Created by Mengyang Guo on 12/10/2022.
//
...
SwiftSpinner.hide()
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "segueDetails" {
            ...
            secondVC.companyNameTxt = "Company Name: \(name)"
            secondVC.compangSymbolTxt = "Company Symbol: \(symbol)"
            secondVC.companyPriceTxt = "The Stock Price: \(price)"
